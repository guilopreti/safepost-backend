...
export const env = {
  ...
  AZURE_CONTENT_SAFETY_ENDPOINT_FOR_IMAGE: process.env
    .AZURE_CONTENT_SAFETY_ENDPOINT_FOR_IMAGE as string,
  AZURE_CONTENT_SAFETY_KEY_FOR_IMAGE: process.env
    .AZURE_CONTENT_SAFETY_KEY_FOR_IMAGE as string,
